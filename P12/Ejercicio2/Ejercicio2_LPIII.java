...
public class Ejercicio2_LPIII extends javax.swing.JFrame {
    int fila;
     DefaultTableModel tablemodel;

    public Ejercicio2_LPIII() {
        initComponents();
   
        try {
            tablemodel = mostrardatos();
        } catch (SQLException ex) {
            Logger.getLogger(Ejercicio2_LPIII.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static DefaultTableModel mostrardatos() throws SQLException {
        ...
        rowSet.setUrl("jdbc:mysql://localhost:3307/catolica");
        rowSet.setUsername("root");
        rowSet.setPassword("root");
        DefaultTableModel modelotable;
        Statement stm = con.createStatement();
        modelotable = new DefaultTableModel(null, new String[]{"ID","First Name","Last Name","Email","Phone Number"});
    ...
    public void mostrar(String tabla) throws SQLException, ClassNotFoundException {
        ...
        if (jTextSQL.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Digitar la sentencia");
        } else {
